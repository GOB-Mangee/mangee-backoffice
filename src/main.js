...
import AlternativesTab from './components/Ingredient/AlternativesTab.vue'
...
const routes = [
  ...
  { path: '/alternatives', name:'Alternative Ingredients', component: AlternativesTab, props: true},
